...
public class EnquiryForm {
		...
		*/
		...
		public EnquiryForm(int id, String name, String dob, String mblno,
		...
		public EnquiryForm(String name, String dob, String mblno, String gender,
		...
		public EnquiryForm(String name, String dob, String mblno,
				String gender, String email, String quali, String state,
				String[] know, String[] course, String date, String address,
				String collegeName, String semester) {
			super();
	...
	*/
		...
		public String toString() {
			return "EnquiryForm [id=" + id + ", name=" + name + ", dob=" + dob
					+ ", mblno=" + mblno + ", gender=" + gender + ", email="
					+ email + ", quali=" + quali + ", state=" + state
					+ ", know=" + Arrays.toString(know) + ", course="
					+ Arrays.toString(course) + ", date=" + date + ", address="
					+ address + ", collegeName=" + collegeName + ", semester="
					+ semester + "]";
		}
