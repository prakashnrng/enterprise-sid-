...
public class RegistrationTo {
	...
	public RegistrationTo() {
	 ...
	 public RegistrationTo(String id, String rasname, String rdob, String rgender,
	...
	public RegistrationTo(String rasname, String rdob, String rgender,
			String rbg, String rmbl, String remial, String rquali,
			String rstate, String rfname, String rfoc, String rmname,
			String rmoc, String rpmad, String rpcnno, 
			String rpaddr, String rdate) {
	...
	/*public RegistrationTo(String id, String rasname, String rdob,
			String rgender, String rbg, String rmbl, String remial,
			String rquali, String rstate, String rfname, String rfoc,
			String rmname, String rmoc, String rpmad, String rpcnno,
			Education redu, String rpaddr, String rdate, Office orf,
			RCourse curs) {
		super();
		this.id = id;
		this.rasname = rasname;
